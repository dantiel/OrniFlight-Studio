...
vi.mock('../simulation/useSimulation.coffee', () => ({
  useSimulation: () => ({
    ...
    servos: [
      {
        name: 'Servo 1', midpoint: 1500, min: 1000,
        max: 2000, rate: 50, amplitudeScale: 1.0,
      },
      {
        name: 'Servo 2', midpoint: 1500, min: 1000,
        max: 2000, rate: 50, amplitudeScale: 1.0,
      },
      {
        name: 'Servo 3', midpoint: 1500, min: 1000,
        max: 2000, rate: 50, amplitudeScale: 1.0,
      },
      {
        name: 'Servo 4', midpoint: 1500, min: 1000,
        max: 2000, rate: 50, amplitudeScale: 1.0,
      },
    ],
    pidGains: {
      roll_P: 4.0, roll_I: 0.03, roll_D: 23.0,
      pitch_P: 6.0, pitch_I: 0.04, pitch_D: 28.0,
      yaw_P: 3.0, yaw_I: 0.05, yaw_D: 0.0,
    },
