...
describe 'App', ->
  ...
  it 'renders the Grundkonfiguration view on /basic/body', ->
    renderApp()
    el = document.querySelector '.ornithopter-view'
    expect(el).toBeInTheDocument()

  it 'renders the wings view layout', ->
    renderWings()
  ...
  it 'renders gyro rate display in perception view', ->
    render h(MemoryRouter, { initialEntries: ['/sensors/gyro'] }, h(App, null))
